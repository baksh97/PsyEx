...
//        String instr = getString(getResources().getIdentifier("instr_questionnaire"+String.valueOf(questionnaire_num),"string",packageName));
        String instr = getString(R.string.instr_questionnaire5);
        instr_ques.setText(instr);
        List<String> questions = Arrays.asList(getResources().getStringArray(R.array.questions5));

        mAdapter = new question_adapter(questions, 5);
...
//        recyclerView.setItemAnimator(new DefaultItemAnimator());
        ...
        continuebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                File file= new File(ChooseMode.userfolder, "questionnaire5.csv");
...
//                getInputs();
                ...
                finish();
                startActivity(new Intent(Questionnaire5.this, DecideOrder.returnNext()));
//                }
//                else{
//                    Toast.makeText(Questionnaire5.this, "Please fill in all the responses!", Toast.LENGTH_SHORT).show();
//                }
