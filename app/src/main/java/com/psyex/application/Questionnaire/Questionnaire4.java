...
//        String instr = getString(getResources().getIdentifier("instr_questionnaire"+String.valueOf(questionnaire_num),"string",packageName));
        String instr = getString(R.string.instr_questionnaire4);
        instr_ques.setText(instr);
        List<String> questions = Arrays.asList(getResources().getStringArray(R.array.questions4));

        mAdapter = new question_adapter(questions, 4);
...
//        recyclerView.setItemAnimator(new DefaultItemAnimator());
        ...
        continuebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                File file= new File(ChooseMode.userfolder, "questionnaire4.csv");
...
//                getInputs();
                ...
                finish();
                startActivity(new Intent(Questionnaire4.this, DecideOrder.returnNext()));
//                }
//                else{
//                    Toast.makeText(Questionnaire4.this, "Please fill in all the responses!", Toast.LENGTH_SHORT).show();
//                }
