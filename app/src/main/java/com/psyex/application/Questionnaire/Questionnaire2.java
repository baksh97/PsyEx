...
//        String instr = getString(getResources().getIdentifier("instr_questionnaire"+String.valueOf(questionnaire_num),"string",packageName));
        String instr = getString(R.string.instr_questionnaire2);
        instr_ques.setText(instr);
        List<String> questions = Arrays.asList(getResources().getStringArray(R.array.questions2));

        mAdapter = new question_adapter(questions, 2);
...
//        recyclerView.setItemAnimator(new DefaultItemAnimator());
        ...
        continuebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                File file = new File(ChooseMode.userfolder, "questionnaire2.csv");
...
//                getInputs();
                ...
                finish();
                startActivity(new Intent(Questionnaire2.this, DecideOrder.returnNext()));
//                }
//                else{
//                    Toast.makeText(Questionnaire2.this, "Please fill in all the responses!", Toast.LENGTH_SHORT).show();
//                }
