...
//    TextView instruc
    ...
    void initViews(){
        continueBtn= (Button) findViewById(R.id.button_continue_instruction_emotions9);
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_instructions_emotions9);
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Instructions9.this, DecideOrder.returnNext());
