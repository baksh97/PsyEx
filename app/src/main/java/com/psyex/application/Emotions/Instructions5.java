...
//    TextView instruc
    ...
    void initViews(){
        continueBtn= (Button) findViewById(R.id.button_continue_instruction_emotions5);
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_instructions_emotions5);
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Instructions5.this, Instructions6.class);
